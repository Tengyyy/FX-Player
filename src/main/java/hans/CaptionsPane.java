...
public class CaptionsPane {
    ...
    VBox currentCaptionsTab = new VBox();

    HBox toggleBox = new HBox();
    Label toggleLabel = new Label();
    MFXToggleButton captionsToggle = new MFXToggleButton();
    ...
    Label currentCaptionsLabel = new Label();
    Label currentCaptionsNameLabel = new Label();
    ...
    CaptionsPane(CaptionsController captionsController){
        ...
        captionsBox.setMinSize(235, 214);
    ...
    public void closeCaptionsPane(){
        ...
        captionsController.settingsController.settingsHomeOpen = true;
        captionsController.settingsController.captionsPaneOpen = false;
    ...
    public void openCaptionsOptions(){
        System.out.println("Opening captions options");
    }
