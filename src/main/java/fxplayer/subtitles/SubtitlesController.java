...
import fxplayer.menu.*;
import fxplayer.srtParser.srt.SRTParser;
import fxplayer.srtParser.srt.Subtitle;
...
import static fxplayer.AnimationsClass.ANIMATION_SPEED;
import static fxplayer.mediaItems.MediaUtilities.FFMPEG_PATH;
...
public class SubtitlesController {
    ...
    public Boolean extractSubtitles(MediaItem mediaItem){
        ...
        Platform.runLater(() -> mediaItem.subtitlesExtractionInProgress.set(true));
        try {
        ...
        Platform.runLater(() -> mediaItem.subtitlesExtractionInProgress.set(false));
        return true;
    }
