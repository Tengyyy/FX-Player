...
public class ExpandableTextArea extends VBox {
    ...
    // ******************** Constructors *******************************
    public ExpandableTextArea(MainController mainController) {
        this("", true, false, 2, Integer.MAX_VALUE, -1, mainController);
    }
    public ExpandableTextArea(final String text, MainController mainController) {
        this(text, true, false, 2, Integer.MAX_VALUE, -1, mainController);
    }
    public ExpandableTextArea(final String text, final int compactNoOfLines, MainController mainController) {
        this(text, true, false, compactNoOfLines, Integer.MAX_VALUE, -1, mainController);
    }
    public ExpandableTextArea(final String text, final boolean expandable, final int compactNoOfLines, MainController mainController) {
        this(text, expandable, false, compactNoOfLines, Integer.MAX_VALUE, -1, mainController);
    }
    public ExpandableTextArea(final String text, final boolean expandable, final int compactNoOfLines, final int maxNoOfCharacters, final int characterThreshold, MainController mainController) {
        this(text, expandable, false, compactNoOfLines, maxNoOfCharacters, characterThreshold, mainController);
    }
    public ExpandableTextArea(final String text, final boolean expandable, final boolean fixedHeight, MainController mainController) {
        this(text, expandable, fixedHeight, 2, Integer.MAX_VALUE, -1, mainController);
    }
    public ExpandableTextArea(final String text, final boolean expandable, final boolean fixedHeight, final int compactNoOfLines, MainController mainController) {
        this(text, expandable, fixedHeight, compactNoOfLines, Integer.MAX_VALUE, -1, mainController);
    }
    public ExpandableTextArea(final String text, final boolean expandable, final boolean fixedHeight, final int compactNoOfLines, final int maxNoOfCharacters, final int characterThreshold, MainController mainController) {
        super();
