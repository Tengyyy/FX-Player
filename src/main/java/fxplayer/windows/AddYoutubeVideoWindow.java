...
public class AddYoutubeVideoWindow {
    ...
    static String pattern = "^(?:https?:)?(?://)?(?:youtu\\.be/|(?:www\\.|m\\.)?youtube\\.com/(?:watch|v|embed)(?:\\.php)?(?:\\?.*v=|/))([a-zA-Z0-9_-]{7,15})(?:[?&][a-zA-Z0-9_-]+=[a-zA-Z0-9_-]+)*(?:[&/#].*)?$";
    static Pattern regexPatern = Pattern.compile(pattern);
