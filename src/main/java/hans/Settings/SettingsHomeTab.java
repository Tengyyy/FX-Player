...
import hans.App;
import hans.SVG;
import hans.Settings.SettingsHomeController;
...
public class SettingsHomeTab extends HBox {
    ...
    SettingsHomeTab(SettingsHomeController settingsHomeController, boolean requiresSubText, SVGPath iconSVG, String mainTextValue, String subTextValue){

        this.settingsHomeController = settingsHomeController;
        ...
        settingsHomeController.settingsHome.getChildren().add(this);
    }
}
