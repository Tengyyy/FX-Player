...
import fxplayer.windows.chapterEdit.ChapterEditWindow;
import fxplayer.windows.equalizer.EqualizerWindow;
import fxplayer.windows.mediaInformation.MediaInformationWindow;
import fxplayer.windows.openSubtitles.OpenSubtitlesState;
import fxplayer.windows.openSubtitles.OpenSubtitlesWindow;
    ...
    public void updateState(WindowState newState) {
        ...
        switch (windowState) {
            ...
            case CHAPTER_EDIT_WINDOW_OPEN -> {
                ...
                if (chapterEditWindow.frameService != null && !chapterEditWindow.frameService.isShutdown())
                    chapterEditWindow.frameService.shutdown();
